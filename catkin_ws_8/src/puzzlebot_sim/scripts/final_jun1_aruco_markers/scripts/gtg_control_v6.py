...
class GTGClass():  
    ...
    def __init__(self):  
        ...
        # goals = [ [0.55, 0.80] ]
        # goals = [ [1.79, 3.26], [0.93, 4.45], [2.38, 1.42], [1.42, 0.22] ]   #2.06, 1.50
        goals = [ [0.51, 2.08], [2.39, 4.77], [1.79, 3.57], [1.53, 1.30], [1.42, 0.21] ]
        ...
        while not rospy.is_shutdown():
            ...
            if (self.flag == "Stop"):
                ...
                Kt          = 0.3 # 0.5 - 1.6, 0.4
                # Linear
                alpha, kmax = 1.15, 0.12 # 1.1, 0.12 Bug 0 tested
                ######
