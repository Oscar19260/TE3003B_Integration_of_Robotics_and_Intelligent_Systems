...
class WallFollowingControlClass():  
    ...
    def __init__(self):  
        ...
        while not rospy.is_shutdown():  
            ...
            if self.laser_received and self.control_received and self.ed_received and self.ed_theta_received and self.v_sp_received:
                ...
                fw_distance = 0.3                   # Following wall distance [m] -- # 0.25
