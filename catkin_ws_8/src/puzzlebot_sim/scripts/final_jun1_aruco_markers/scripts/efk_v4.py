...
class EKFClass():  
    def __init__(self):  
        ...
        self.start_pos_pub   = rospy.Publisher('start_pos_zero', Vector3, queue_size=1)
        ...
        ############ Variables ############### 
        init_pose = [1.42, 0.21, np.pi/2]              # INIT POSE
        ...
        while not rospy.is_shutdown(): 
            ...
            if aruco_flag == 1:
                ...
                print("zk")
                print(zk)
                [x_efk, y_efk, theta_efk, cov_mat_final_efk] = self.kf_correct(x, y, theta, Ek, m_detected, Rk, zk) #correct KF
                odom_ekf = [x_efk, y_efk, theta_efk, cov_mat_final_efk]
