...
class PuzzlebotKinClass():  
    ...
    def __init__(self):  
        ...
        self.wr_pub = rospy.Publisher('wr_rviz', Float32 ,queue_size=1) # Publisher to wr topic 

        self.wl_pub = rospy.Publisher('wl_rviz', Float32 ,queue_size=1) # Publisher to wl topic 
