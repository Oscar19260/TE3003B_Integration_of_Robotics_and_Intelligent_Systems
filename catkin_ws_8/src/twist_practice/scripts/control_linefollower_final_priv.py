...
class ColorFollowerClass():  
    ...
    def __init__(self):  
        ...
        while not rospy.is_shutdown():
            ...
            if (self.center_received == True and self.colour_received == True and self.line_received == True and self.id_prediction_received == True):            # remove as True
                ...
                if (d_line == "line" and b == 0):
                    ...
                    if (self.colour == "red" and c == 0):
                        print("Entro WE")
                        vel = Twist()
                    else: vel.linear.x, vel.angular.z = self.f_v, self.f_w
                    
                    
                if (d_line == "no_line" or b == 1):
                    ...
                    if (id_pred == "0"):
                        ...
                        print(" ")
                        break
                    elif (id_pred == "3"): vel.linear.x, vel.angular.z = self.f_v, self.f_w
                    elif (id_pred == "2"):
