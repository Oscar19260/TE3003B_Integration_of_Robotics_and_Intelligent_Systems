...
class TrackbarClass():  
    ...
    def __init__(self):  
        ...
        while not rospy.is_shutdown():
            ...
            if self.image_received:
                ...
                img_final_r = self.getContours(imgCanny_red, im2r, self.flag)
                ...
                img_final_g = self.getContours(imgCanny_green, im2g, self.flag)
                ...
                img_final_f = self.getContours(imgCanny_final, im3, min_area_2)
    ...
    def getContours(self, img, imgContour, flago):
        ...
        for cnt in contours:
            ...
            if (area >= min_area and area <= 1000):
                self.counter = 1
                area_min = min_area
            if (area >= min_area_2 and area <= 2000):
                self.counter = 2
                area_min = min_area_2
