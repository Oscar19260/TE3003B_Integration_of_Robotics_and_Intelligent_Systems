...
class IMGProcessingNodeClass():  
    ...
    def __init__(self):
        ...
        self.line_no_line_pub = rospy.Publisher('line', String, queue_size=1)
        ...
        while not rospy.is_shutdown():
            ...
            if self.image_received:
                ...
                im_bw_2 = im_bw.copy()                          ## BITWISE RESULTS
                ...
                img_erode_2 = img_g_w_k.copy()                  ## EROTION RESULTS
                #cv = img_g_w_k.copy()
                ...
                img_canny_2 = img_canny.copy()                  ## CANNY RESULTS
                #cv = img_canny.copy()
                ...
                N = 21  # N maximum values SIEMPRE IMPAR
                ...
                #cv2.imshow('bitwise_image_otsu_or_bin_inv', im_bw_2)
                #cv2.imshow('erotion_image_k_30', img_erode_2)
                #cv2.imshow('canny_image_k_0_255', img_canny_2)
                ...
                #self.line_no_line_pub.publish(self.msg_string.data)
                ...
                #cv2.imshow('bitwise_image_otsu_or_bin_inv', cv)
